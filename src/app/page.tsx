...
───────────────────────────────────────── */
const DISHES = [
  { id:1, name:"Jollof Rice",    price:"$14", tag:"Fan Favourite",  tagBg:"rgba(212,168,67,.15)", tagC:"#D4A843", tagBdr:"rgba(212,168,67,.4)",  desc:"Party-style smoky jollof with a perfectly scorched base. Made fresh every single day.",                 img:"/images/jollof.jpg",      col:7 },
  { id:2, name:"Suya Platter",   price:"$18", tag:"Bestseller",     tagBg:"rgba(192,57,43,.15)",  tagC:"#e74c3c", tagBdr:"rgba(192,57,43,.4)",   desc:"Spiced grilled beef skewers with onions, tomatoes & the iconic yaji spice rub.",                          img:"/images/suya.jpg",        col:5 },
  { id:3, name:"Egusi Soup",     price:"$16", tag:"Chef's Special", tagBg:"rgba(230,126,34,.15)", tagC:"#e67e22", tagBdr:"rgba(230,126,34,.4)",  desc:"Rich melon seed soup slow-cooked with assorted meat, leafy greens & palm oil.",                           img:"/images/egusi.jpg",       col:4 },
  { id:4, name:"Pounded Yam",    price:"$12", tag:"Comfort Food",   tagBg:"rgba(39,174,96,.12)",  tagC:"#27ae60", tagBdr:"rgba(39,174,96,.35)",  desc:"Silky smooth swallow with your choice of rich, hearty Nigerian soup.",                                    img:"/images/pounded-yam.jpg", col:4 },
  { id:5, name:"Pepper Soup",    price:"$15", tag:"Spicy 🔥",        tagBg:"rgba(155,89,182,.12)", tagC:"#9b59b6", tagBdr:"rgba(155,89,182,.3)",  desc:"Spicy native pepper soup with assorted proteins & aromatic spices.",                                      img:"/images/pepper-soup.jpg", col:4 },
];
  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* ── Hover Effects ── */
        .h-cat    { transition:transform .4s cubic-bezier(.23,1,.32,1),box-shadow .4s !important; }
        ...
        .h-dish   { transition:transform .45s cubic-bezier(.23,1,.32,1),box-shadow .45s,border-color .3s !important; }
        ...
        .h-why    { transition:transform .4s cubic-bezier(.23,1,.32,1),border-color .3s,box-shadow .4s !important; }
        ...
        .h-rv    { transition:transform .38s cubic-bezier(.23,1,.32,1),border-color .3s,box-shadow .38s !important; }
        ...
        .h-oc-g { transition:all .45s cubic-bezier(.23,1,.32,1) !important; }
        ...
        .h-oc-r { transition:all .45s cubic-bezier(.23,1,.32,1) !important; }
        ...
        /* No hover on touch */
        @media(hover:none) {
          .h-cat:hover,.h-dish:hover,.h-why:hover,.h-rv:hover,.h-oc-g:hover,.h-oc-r:hover,
          .btn-g:hover,.btn-o:hover { transform:none !important; box-shadow:none !important; }
        }

        /* Mobile dish snap-scroll */
        .mob-scroll { display:flex;overflow-x:auto;gap:14px;padding:0 20px 8px;
        ...
        @media(max-width:768px) {
          ...
          .hero-w { padding:116px 20px 84px !important; }
          ...
          .ord-g  { grid-template-columns:1fr !important; }
          .sto-g  { grid-template-columns:1fr !important; gap:44px !important; }
          .rev-g  { grid-template-columns:1fr !important; max-width:420px !important;
                    margin-left:auto !important; margin-right:auto !important; }
          .why-g  { grid-template-columns:repeat(2,1fr) !important; gap:12px !important; }
          .spl-g  { grid-template-columns:1fr !important; }
          .spl-i  { min-height:240px !important; position:relative !important; }
          ...
          .vln  { display:none !important; }
          .oc-p { padding:28px 22px !important; }
          .sto-vis { display:none !important; }
          .sto-vm  { display:block !important; }
          .spl-txt { padding:44px 24px !important; }
        }
        @media(min-width:769px) {
          .mob       { display:none !important; }
          .sto-vm    { display:none !important; }
        }
      `}</style>
      ...
      <section id="hero" style={{
        ...
        <div style={{ position:"absolute",inset:"-50%",width:"200%",height:"200%",zIndex:3,
          pointerEvents:"none",opacity:.032,
        ...
        <div className="vln" style={{ position:"absolute",left:56,top:0,bottom:0,width:1,zIndex:4,
          background:"linear-gradient(to bottom,transparent,rgba(212,168,67,.24) 22%,rgba(212,168,67,.24) 78%,transparent)" }}/>
        <div className="vln" style={{ position:"absolute",right:56,top:0,bottom:0,width:1,zIndex:4,
          background:"linear-gradient(to bottom,transparent,rgba(212,168,67,.24) 22%,rgba(212,168,67,.24) 78%,transparent)" }}/>
        ...
        <div className="hero-w" style={{ position:"relative",zIndex:10,textAlign:"center",
          ...
          <h1 style={{ fontFamily:"'Cormorant Garamond',Georgia,serif",
            fontWeight:300,lineHeight:.86,marginBottom:28,
            animation:"heroUp 1.1s ease .38s both" }}>
            <span style={{ display:"block",fontSize:"clamp(3.8rem,12.5vw,11rem)",
              color:"#fff",letterSpacing:"-.015em" }}>Oga Madam</span>
            <span style={{ display:"block",fontSize:"clamp(3.8rem,12.5vw,11rem)",
              color:GOLD,fontStyle:"italic",letterSpacing:"-.015em" }}>Kitchen</span>
          </h1>

          {/* Divider */}
          <div style={{ display:"flex",alignItems:"center",justifyContent:"center",
            gap:16,marginBottom:28,animation:"heroUp .8s ease .55s both" }}>
          ...
          {/* Buttons */}
          <div className="hero-btns" style={{ display:"flex",alignItems:"center",
            justifyContent:"center",gap:13,flexWrap:"wrap",marginBottom:66,
            animation:"heroUp .8s ease .82s both" }}>
            <a href="#order-section" onClick={e=>{e.preventDefault();go("#order-section");}}
              className="btn-g"
            ...
            <a href="#categories" onClick={e=>{e.preventDefault();go("#categories");}}
              className="btn-o"
              style={{ display:"inline-flex",alignItems:"center",gap:8,
                border:"1.5px solid rgba(212,168,67,.5)",color:GOLD,
                padding:"16px 36px",borderRadius:999,fontSize:13,fontWeight:600,
          ...
          <div className="stats" style={{ display:"grid",gridTemplateColumns:"repeat(4,1fr)",
            ...
            animation:"heroUp .8s ease .97s both" }}>
            {[["4.5 ★","Rating"],["50+","Dishes"],["30 min","Delivery"],["100%","Fresh Daily"]].map(([v,l]) => (
              <div key={l} className="h-stat"
                ...
                <div style={{ fontFamily:"'Cormorant Garamond',Georgia,serif",
                  ...
                  color:GOLD,lineHeight:1,marginBottom:5 }}>{v}</div>
                <div style={{ fontSize:9,letterSpacing:".26em",textTransform:"uppercase",
                  color:"rgba(255,255,255,.24)" }}>{l}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ position:"absolute",bottom:28,left:"50%",transform:"translateX(-50%)",
          ...
          zIndex:10,animation:"heroUp .6s ease 1.6s both" }}>
          <span style={{ fontSize:9,letterSpacing:".42em",textTransform:"uppercase",
            color:"rgba(255,255,255,.2)" }}>Scroll</span>
          <div style={{ width:1,height:36,
            background:`linear-gradient(to bottom,${GOLD},transparent)`,
            animation:"scBar 2s ease-in-out infinite" }}/>
        </div>
      </section>
      ...
      {/* ════════════════════════════════════════
          § 2 · MARQUEE TICKER
      ════════════════════════════════════════ */}
      <div style={{ padding:"18px 0",background:GOLD,overflow:"hidden",
        ...
        <div style={{ display:"flex",whiteSpace:"nowrap",animation:"marq 24s linear infinite" }}>
          {["Jollof Rice","Egusi Soup","Suya Platter","Pounded Yam","Pepper Soup","Fried Plantain","Ofe Onugbu","Moi Moi"].flatMap((item,i) =>
            [0,1].map(j => (
              <span key={`${i}${j}`} style={{ display:"inline-flex",alignItems:"center",
                gap:16,padding:"0 20px",fontSize:11.5,fontWeight:800,
                letterSpacing:".22em",textTransform:"uppercase",color:"#000" }}>
                {item}
      ...
      <section id="categories" className="sec"
        style={{ padding:"96px 56px",background:bg2,transition:"background .5s" }}>
        ...
        <div className="cat-g" style={{ display:"grid",gridTemplateColumns:"repeat(5,1fr)",
          gap:14,maxWidth:1200,margin:"0 auto" }}>
          {CATS.map(({ name, sub, img }, i) => (
            <a key={name} href="/menu"
              className={`h-cat rv d${i+1}`}
              ...
              <div className="cat-bdr" style={{ position:"absolute",inset:0,borderRadius:22,
                border:"1px solid rgba(255,255,255,.06)",pointerEvents:"none",
                transition:"border-color .35s" }}/>
              <div style={{ position:"absolute",bottom:0,left:0,right:0,
                padding:"16px 14px",textAlign:"center" }}>
                <span className="cat-nm" style={{ fontSize:13,fontWeight:600,color:"#fff",
                  display:"block",transition:"color .3s" }}>{name}</span>
                <span style={{ fontSize:9,letterSpacing:".28em",textTransform:"uppercase",
                  color:"rgba(255,255,255,.4)",marginTop:3,display:"block" }}>{sub}</span>
              </div>
            </a>
          ))}
        </div>
      ...
      <section id="featured" className="sec"
        style={{ padding:"96px 56px",background:bg,transition:"background .5s" }}>

        {/* Header */}
        <div className="rv" style={{ maxWidth:1200,margin:"0 auto 52px",
          ...
          <a href="/menu" className="lnk"
            style={{ color:fg3,fontSize:11,letterSpacing:".2em",textTransform:"uppercase",
              textDecoration:"none",borderBottom:`1px solid ${cardBdr}`,paddingBottom:3,
              cursor:"none",transition:"color .3s,border-color .3s" }}>Full Menu →</a>
        </div>

        {/* ── Desktop bento grid ── */}
        <div className="desk" style={{ display:"grid",gridTemplateColumns:"repeat(12,1fr)",
          gap:16,maxWidth:1200,margin:"0 auto" }}>
          {DISHES.map((d, i) => {
            const big = i < 2;
            return (
              <div key={d.id} className={`h-dish rv d${i+1}`}
                style={{ gridColumn:`span ${d.col}`,background:card,
                  border:`1px solid ${cardBdr}`,borderRadius:24,overflow:"hidden" }}>
                <div style={{ position:"relative",overflow:"hidden",height:big?296:218 }}>
                  ...
                  <span style={{ position:"absolute",top:14,left:14,fontSize:10,fontWeight:700,
                    letterSpacing:".1em",textTransform:"uppercase",padding:"5px 14px",
                    borderRadius:999,backdropFilter:"blur(10px)",
                    background:d.tagBg,color:d.tagC,border:`1px solid ${d.tagBdr}` }}>{d.tag}</span>
                  <span style={{ position:"absolute",top:14,right:14,background:GOLD,color:"#000",
                    fontSize:big?15:14,fontWeight:800,
                    fontFamily:"'Cormorant Garamond',Georgia,serif",
                    padding:"5px 14px",borderRadius:999 }}>{d.price}</span>
                </div>
                <div style={{ padding:big?"20px 24px 24px":"14px 18px 20px" }}>
                  <span style={{ fontFamily:"'Cormorant Garamond',Georgia,serif",
                    fontSize:big?22:18,fontWeight:600,color:fg,display:"block",
                    marginBottom:7,transition:"color .4s" }}>{d.name}</span>
                  <p style={{ fontSize:big?13:12,color:fg2,lineHeight:1.68,marginBottom:16,
                    transition:"color .4s" }}>{d.desc}</p>
                  <a href="/order" className="d-add"
                    style={{ display:"flex",alignItems:"center",justifyContent:"center",
                      padding:big?11:10,borderRadius:12,
                      border:"1px solid rgba(212,168,67,.18)",color:GOLD,
                      fontSize:big?12:11,fontWeight:700,letterSpacing:".08em",
        ...
        <div className="mob mob-scroll">
          {DISHES.map(d => (
            <div key={d.id} className="mob-dish"
              style={{ background:card,border:`1px solid ${cardBdr}`,
                borderRadius:20,overflow:"hidden" }}>
              <div style={{ position:"relative",overflow:"hidden",height:178 }}>
                <img src={d.img} alt={d.name}
                  style={{ width:"100%",height:"100%",objectFit:"cover",display:"block",filter:"brightness(.76)" }}/>
                <div style={{ position:"absolute",inset:0,
                  background:`linear-gradient(to top,${card} 0%,transparent 55%)` }}/>
                <span style={{ position:"absolute",top:10,left:10,fontSize:9,fontWeight:700,
                  letterSpacing:".08em",textTransform:"uppercase",padding:"4px 11px",
                  borderRadius:999,backdropFilter:"blur(8px)",
                  background:d.tagBg,color:d.tagC,border:`1px solid ${d.tagBdr}` }}>{d.tag}</span>
                <span style={{ position:"absolute",top:10,right:10,background:GOLD,color:"#000",
                  fontSize:13,fontWeight:800,
                  fontFamily:"'Cormorant Garamond',Georgia,serif",
                  padding:"4px 11px",borderRadius:999 }}>{d.price}</span>
              </div>
              <div style={{ padding:"15px 16px 18px" }}>
                <span style={{ fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:18,
                  fontWeight:600,color:fg,display:"block",marginBottom:5,
                  transition:"color .4s" }}>{d.name}</span>
                <p style={{ fontSize:12,color:fg2,lineHeight:1.62,marginBottom:12,
                  transition:"color .4s" }}>{d.desc}</p>
                <a href="/order"
                  style={{ display:"flex",alignItems:"center",justifyContent:"center",
                    padding:10,borderRadius:10,border:"1px solid rgba(212,168,67,.22)",
                    color:GOLD,fontSize:11,fontWeight:700,letterSpacing:".08em",
                    textTransform:"uppercase",textDecoration:"none" }}>
                  Add to Order +
                </a>
              </div>
      ...
      {/* ════════════════════════════════════════
          § 5 · SIGNATURE SPLIT
      ════════════════════════════════════════ */}
      <section style={{ background:bg2,position:"relative",overflow:"hidden",
        transition:"background .5s" }}>
        <div className="spl-g" style={{ display:"grid",gridTemplateColumns:"1fr 1fr",
          minHeight:580 }}>
          {/* Image */}
          <div className="spl-i" style={{ position:"relative",overflow:"hidden",minHeight:260 }}>
            <img src="/images/jollof.jpg" alt="Jollof"
              style={{ position:"absolute",inset:0,width:"100%",height:"100%",
                objectFit:"cover",filter:"brightness(.62)",display:"block" }}/>
            <div style={{ position:"absolute",inset:0,
              background:`linear-gradient(to right,transparent 50%,${bg2} 100%)` }}/>
            {/* Award pill */}
            <div style={{ position:"absolute",top:32,left:32,
              background:GOLD,color:"#000",padding:"11px 22px",borderRadius:999,
              fontSize:12,fontWeight:800,letterSpacing:".06em",textTransform:"uppercase",
              boxShadow:"0 8px 30px rgba(212,168,67,.55)",
            ...
            <div style={{ position:"absolute",bottom:24,right:24,
              fontFamily:"'Cormorant Garamond',Georgia,serif",
              fontSize:120,fontWeight:700,color:"rgba(212,168,67,.07)",
              lineHeight:1,userSelect:"none",pointerEvents:"none" }}>01</div>
          </div>

          {/* Text */}
          <div className="rv spl-txt" style={{ display:"flex",flexDirection:"column",
            justifyContent:"center",padding:"72px 64px",
            background:bg2,transition:"background .5s" }}>
            <span style={sLabel}>Signature Dish</span>
            <h2 style={{ ...sH2, fontSize:"clamp(2.6rem,4.8vw,4.8rem)", marginBottom:18 }}>
              Our Famous<br/>Jollof Rice
            </h2>
            <div style={{ fontFamily:"'Cormorant Garamond',Georgia,serif",
              fontSize:"2.2rem",fontWeight:600,color:GOLD,marginBottom:22 }}>$14</div>
            <p style={{ fontSize:15,color:fg2,lineHeight:1.95,marginBottom:36,
              maxWidth:360,transition:"color .4s" }}>
              Slow-cooked, party-style jollof rice with a smoky, scorched base perfected over generations. The dish Minneapolis can't stop talking about — made from scratch every single day.
            </p>
            <a href="/order" className="btn-g"
              style={{ alignSelf:"flex-start",display:"inline-flex",
                alignItems:"center",gap:10,
                background:GOLD,color:"#000",padding:"15px 36px",borderRadius:999,
                fontSize:13,fontWeight:700,letterSpacing:".09em",textTransform:"uppercase",
                textDecoration:"none",border:"none",
                transition:"all .32s cubic-bezier(.23,1,.32,1)",cursor:"none" }}>
      ...
      ════════════════════════════════════════ */}
      <section id="order-section" className="sec"
        style={{ padding:"96px 56px",background:bg,transition:"background .5s" }}>
        ...
        <div className="ord-g" style={{ display:"grid",gridTemplateColumns:"1fr 1fr",
          gap:20,maxWidth:1200,margin:"0 auto 20px" }}>
          {/* Pickup */}
          <div className="h-oc-g rv d1 oc-p"
            style={{ borderRadius:28,padding:"46px 42px",position:"relative",
              overflow:"hidden",border:"1px solid rgba(212,168,67,.18)",background:card }}>
            <div style={{ position:"absolute",width:320,height:320,borderRadius:"50%",
              filter:"blur(90px)",background:"rgba(212,168,67,.055)",
              top:-100,right:-100,pointerEvents:"none" }}/>
            <div style={{ width:52,height:52,borderRadius:16,display:"flex",
              alignItems:"center",justifyContent:"center",fontSize:22,marginBottom:24,
              background:"rgba(212,168,67,.1)",border:"1px solid rgba(212,168,67,.2)" }}>🏪</div>
            <span style={{ ...sLabel, marginBottom:10 }}>In-Store</span>
            <h3 style={{ fontFamily:"'Cormorant Garamond',Georgia,serif",
              fontSize:"clamp(1.9rem,2.8vw,2.8rem)",fontWeight:400,
              color:fg,marginBottom:14,transition:"color .4s" }}>Pickup</h3>
            <p style={{ fontSize:14,color:fg2,lineHeight:1.88,marginBottom:28,
              transition:"color .4s" }}>
              Order online and collect fresh from our kitchen. Your food is ready the moment you walk in — zero wait time.
            </p>
            {[["📍","6000 Shingle Creek Pkwy, Minneapolis, MN 55430"],
              ["⏱","Ready in 15–25 minutes"],
              ["📞","(763) 200-5773"]].map(([ic,t]) => (
            ...
            <a href="/order" className="btn-g"
              style={{ display:"inline-flex",alignItems:"center",gap:8,
                padding:"13px 30px",borderRadius:999,fontSize:13,fontWeight:700,
                letterSpacing:".07em",textTransform:"uppercase",textDecoration:"none",
                marginTop:22,cursor:"none",background:GOLD,color:"#000",border:"none",
          ...
          {/* Delivery */}
          <div className="h-oc-r rv d2 oc-p"
            style={{ borderRadius:28,padding:"46px 42px",position:"relative",
              overflow:"hidden",border:"1px solid rgba(192,57,43,.16)",background:card }}>
            <div style={{ position:"absolute",width:320,height:320,borderRadius:"50%",
              filter:"blur(90px)",background:"rgba(192,57,43,.055)",
              top:-100,left:-100,pointerEvents:"none" }}/>
            <div style={{ width:52,height:52,borderRadius:16,display:"flex",
              alignItems:"center",justifyContent:"center",fontSize:22,marginBottom:24,
              background:"rgba(192,57,43,.1)",border:"1px solid rgba(192,57,43,.2)" }}>🚗</div>
            <span style={{ ...sLabel, color:RED, marginBottom:10 }}>To Your Door</span>
            <h3 style={{ fontFamily:"'Cormorant Garamond',Georgia,serif",
              fontSize:"clamp(1.9rem,2.8vw,2.8rem)",fontWeight:400,
              color:fg,marginBottom:14,transition:"color .4s" }}>Delivery</h3>
            <p style={{ fontSize:14,color:fg2,lineHeight:1.88,marginBottom:28,
              transition:"color .4s" }}>
              Direct delivery — no third-party cut. Lower fees, fresher food, faster to your door. We own the experience end-to-end.
            </p>
            {[["🗺","Within 10-mile radius of Minneapolis"],
              ["⏱","Estimated 30–45 minutes"],
              ["💳","Card, Apple Pay & Google Pay accepted"]].map(([ic,t]) => (
              <div key={String(t)} style={{ display:"flex",alignItems:"flex-start",gap:12,marginBottom:12 }}>
                <span style={{ fontSize:14,flexShrink:0,marginTop:1 }}>{ic}</span>
                <span style={{ fontSize:13,color:fg2,lineHeight:1.6,transition:"color .4s" }}>{t}</span>
              </div>
            ))}
            <a href="/order" className="btn-r"
              style={{ display:"inline-flex",alignItems:"center",gap:8,
                padding:"13px 30px",borderRadius:999,fontSize:13,fontWeight:700,
                letterSpacing:".07em",textTransform:"uppercase",textDecoration:"none",
                marginTop:22,cursor:"none",background:RED,color:"#fff",border:"none",
                transition:"all .32s cubic-bezier(.23,1,.32,1)" }}>
              Order for Delivery
            </a>
          </div>
        ...
        <div className="rv" style={{ maxWidth:1200,margin:"0 auto",
          background:"rgba(212,168,67,.04)",border:"1px solid rgba(212,168,67,.11)",
          ...
          <p style={{ fontSize:14,color:fg2,lineHeight:1.65,margin:0,transition:"color .4s" }}>
            <strong style={{ color:fg,transition:"color .4s" }}>Skip the 30% DoorDash cut.</strong>{" "}
            Order directly — better prices, faster delivery, and you support us directly.
          </p>
          <a href="/order" className="skip"
            style={{ fontSize:11,fontWeight:700,letterSpacing:".12em",textTransform:"uppercase",
              color:GOLD,textDecoration:"none",
              border:"1px solid rgba(212,168,67,.28)",padding:"9px 22px",borderRadius:999,
              whiteSpace:"nowrap",transition:"all .3s",cursor:"none",
              background:"transparent" }}>Order Direct →</a>
        </div>
      </section>
      ...
      <section className="sec" style={{ padding:"96px 56px",background:bg2,transition:"background .5s" }}>
        ...
        <div className="why-g" style={{ display:"grid",gridTemplateColumns:"repeat(4,1fr)",
          gap:16,maxWidth:1200,margin:"0 auto" }}>
          {WHY.map(({ icon, title, body }, i) => (
            <div key={title} className={`h-why rv d${i+1}`}
              ...
              <h4 style={{ fontFamily:"'Cormorant Garamond',Georgia,serif",
                fontSize:20,fontWeight:600,color:fg,marginBottom:10,
                transition:"color .4s" }}>{title}</h4>
      ...
      <section id="story" className="sec"
        style={{ padding:"96px 56px",background:bg,transition:"background .5s" }}>
        <div className="sto-g" style={{ display:"grid",gridTemplateColumns:"1fr 1fr",
          gap:80,alignItems:"center",maxWidth:1200,margin:"0 auto" }}>

          {/* Text */}
          <div className="rv">
            <span style={sLabel}>Our Story</span>
            <h2 style={{ ...sH2, fontSize:"clamp(2.4rem,5.2vw,5.2rem)", marginBottom:36 }}>
              Born from<br/>Tradition.<br/>
            ...
            {[
              ...
              <p key={i} style={{ fontSize:15,color:fg2,lineHeight:1.95,marginBottom:18,
                transition:"color .4s" }}>{p}</p>
            ))}
            <a href="/about" className="lnk"
              style={{ display:"inline-flex",alignItems:"center",gap:8,color:GOLD,
                fontSize:12,fontWeight:700,textDecoration:"none",
                letterSpacing:".12em",textTransform:"uppercase",marginTop:24,
                borderBottom:"1px solid rgba(212,168,67,.3)",paddingBottom:4,
          ...
          <div className="sto-vis rv d2" style={{ position:"relative" }}>
            <div style={{ borderRadius:26,overflow:"hidden",position:"relative",height:500 }}>
              <img src="/images/egusi.jpg" alt="Our Kitchen"
                style={{ width:"100%",height:"100%",objectFit:"cover",display:"block",
                  filter:"brightness(.68)",transition:"transform .9s cubic-bezier(.23,1,.32,1)" }}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform="scale(1.05)"; }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform="scale(1)"; }}/>
              <div style={{ position:"absolute",inset:0,
                background:`linear-gradient(to top,${bg} 0%,transparent 48%)` }}/>
            </div>
            {/* Quote float */}
            <div style={{ position:"absolute",bottom:26,left:26,right:26,
              background:isDark?"rgba(13,11,9,.94)":"rgba(238,232,220,.96)",
              backdropFilter:"blur(24px)",
              border:"1px solid rgba(212,168,67,.16)",borderRadius:20,
              padding:"20px 24px",transition:"background .4s" }}>
              <div style={{ fontFamily:"'Cormorant Garamond',Georgia,serif",
                fontSize:18,fontStyle:"italic",color:GOLD,marginBottom:8 }}>
                &quot;Madam&apos;s Secret&quot;
              </div>
              <p style={{ fontSize:13,color:fg2,lineHeight:1.72,margin:0,fontStyle:"italic",
                transition:"color .4s" }}>
                Every dish carries the one ingredient no recipe can teach — the love of a mother cooking for her family.
              </p>
            </div>
            ...
            <span style={{ position:"absolute",bottom:-14,left:-14,
              ...
              transition:"background .4s" }}>Minneapolis, MN</span>
          </div>

          {/* Visual – mobile (simplified) */}
          <div className="sto-vm rv" style={{ borderRadius:20,overflow:"hidden" }}>
            <img src="/images/egusi.jpg" alt="Our Kitchen"
              style={{ width:"100%",height:230,objectFit:"cover",display:"block",filter:"brightness(.68)" }}/>
            <div style={{ background:isDark?"rgba(13,11,9,.94)":"rgba(238,232,220,.96)",
              border:`1px solid rgba(212,168,67,.15)`,borderTop:"none",
              padding:"16px 20px",transition:"background .4s" }}>
              <div style={{ fontFamily:"'Cormorant Garamond',Georgia,serif",
                fontSize:17,fontStyle:"italic",color:GOLD,marginBottom:6 }}>
                &quot;Madam&apos;s Secret&quot;
              </div>
              <p style={{ fontSize:13,color:fg2,lineHeight:1.7,margin:0,fontStyle:"italic",
                transition:"color .4s" }}>
                Every dish carries the one ingredient no recipe can teach.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="reviews" className="sec"
        ...
        <div className="rev-g" style={{ display:"grid",gridTemplateColumns:"repeat(3,1fr)",
          gap:18,maxWidth:1200,margin:"0 auto" }}>
          {REVIEWS.map(({ q, n, r }, i) => (
            <div key={n} className={`h-rv rv d${i+1}`}
              style={{ background:card,border:`1px solid ${cardBdr}`,
                borderRadius:24,padding:"30px 28px" }}>
              <div style={{ color:GOLD,fontSize:13,letterSpacing:3,marginBottom:20 }}>★★★★★</div>
              <p style={{ fontSize:14.5,color:fg2,lineHeight:1.85,fontStyle:"italic",
                marginBottom:24,transition:"color .4s" }}>&ldquo;{q}&rdquo;</p>
              <div style={{ display:"flex",alignItems:"center",gap:12 }}>
                <div style={{ width:38,height:38,borderRadius:"50%",
                  background:"rgba(212,168,67,.12)",border:"1px solid rgba(212,168,67,.22)",
                  display:"flex",alignItems:"center",justifyContent:"center",
                  color:GOLD,fontWeight:700,fontSize:14,flexShrink:0 }}>{n[0]}</div>
                <div>
                  <div style={{ fontSize:14,fontWeight:600,color:fg,
                    transition:"color .4s" }}>{n}</div>
                  <div style={{ fontSize:11,color:fg3,letterSpacing:".04em",
                    marginTop:2,transition:"color .4s" }}>{r}</div>
                </div>
              </div>
            </div>
          ))}
      ...
      <section id="cta" className="sec"
        style={{ padding:"130px 56px",textAlign:"center",
          position:"relative",overflow:"hidden" }}>
        <img src="/images/sa.jpg" alt=""
          style={{ position:"absolute",inset:0,width:"100%",height:"100%",
            objectFit:"cover",filter:"brightness(.14) saturate(.6)",
            display:"block",zIndex:0 }}/>
        <div style={{ position:"absolute",inset:0,
          background:"radial-gradient(ellipse at center,rgba(8,7,6,.25) 0%,rgba(8,7,6,.94) 68%)",
          zIndex:1 }}/>
        ...
        <div className="rv" style={{ position:"relative",zIndex:10,
          ...
          <div className="cta-btns" style={{ display:"flex",alignItems:"center",
            ...
            <a href="/order" className="btn-g"
              style={{ display:"inline-flex",alignItems:"center",gap:10,
                background:GOLD,color:"#000",padding:"17px 48px",borderRadius:999,
                fontSize:14,fontWeight:700,letterSpacing:".09em",textTransform:"uppercase",
                textDecoration:"none",border:"none",
                transition:"all .32s cubic-bezier(.23,1,.32,1)",cursor:"none" }}>
            ...
            <a href="tel:7632005773"
              style={{ display:"inline-flex",alignItems:"center",gap:8,
                ...
                color:"rgba(255,255,255,.5)",padding:"17px 32px",borderRadius:999,
